...
namespace SkiStore.Domain.Contracts
{
    public interface IGenericRepository<T> where T : class
    {
        ...
        Task<List<TResult>> GetAllAsync<TResult>(Expression<Func<T, bool>?> filter=null, Expression<Func<T, object>?> order = null, Expression<Func<T, object>?> orderDesc = null, params string[] properties);
